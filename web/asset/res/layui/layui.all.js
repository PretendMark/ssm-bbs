        ...
        c = function() {
            this.config = {
                verify: {
                    ...
                    email: [/^[a-z0-9]+([._\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$/, "邮箱格式不正确"],
                ...
                select: function() {
                    ...
                    f.each(function(e, l) {
                        ...
                        var v = "string" == typeof s.attr("lay-search"),
                            ...
                            m = i(['<div class="' + (v ? "" : "layui-unselect ") + a + (c ? " layui-select-disabled" : "") + '">', '<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "" : "readonly") + ' class="layui-input' + (v ? "" : " layui-unselect") + (c ? " " + o : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ? " layui-select-group" : "") + '">' +
                            function(e) {
                                var i = [];
