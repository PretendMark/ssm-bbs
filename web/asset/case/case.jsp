...
<head>
  ...
  <link rel="stylesheet" href="${absolute}/asset/res/layui/css/layui.css">
  <link rel="stylesheet" href="${absolute}/asset/res/css/global.css">
  <style>
...
<div class="fly-header layui-bg-black">
  <div class="layui-container">
    <a class="fly-logo" href="/">
      <img src="${absolute}/asset/res/images/logo.png" alt="layui">
    </a>
    <ul class="layui-nav fly-nav layui-hide-xs">
      <li class="layui-nav-item">
        <a href="${absolute}/index.jsp"><i class="iconfont icon-jiaoliu"></i>交流</a>
      </li>
    ...
    <ul class="layui-nav fly-nav-user">
      ...
      <!-- 未登入的状态 -->
      <li class="layui-nav-item">
        <a class="iconfont icon-touxiang layui-hide-xs" href="${absolute}/asset/user/public/login.jsp"></a>
      </li>
      <li class="layui-nav-item">
        <a href="${absolute}/asset/user/public/login.jsp">登入</a>
      </li>
      <li class="layui-nav-item">
        <a href="${absolute}/asset/user/public/reg.jsp">注册</a>
      </li>
      ...
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          <dd><a href="${absolute}/asset/user/set.jsp"><i class="layui-icon">&#xe620;</i>基本设置</a></dd>
          <dd><a href="${absolute}/asset/user/message.jsp"><i class="iconfont icon-tongzhi" style="top: 4px;"></i>我的消息</a></dd>
          <dd><a href="${absolute}/asset/user/home.jsp"><i class="layui-icon" style="margin-left: 2px; font-size: 22px;">&#xe68e;</i>我的主页</a></dd>
...
<div class="fly-case-header">
  ...
  <a href="${absolute}/asset/case/{{ year }}/case.jsp">
    <img class="fly-case-banner" src="${absolute}/asset/res/images/case.png" alt="发现 Layui 年度最佳案例">
  </a>
  ...
  <ul class="fly-case-list">
    <li data-id="123">
      <a class="fly-case-img" href="http://fly.layui.com/" target="_blank" >
        <img src="${absolute}/asset/res/images/fly.jpg" alt="Fly社区">
      ...
      <div class="fly-case-info">
        <a href="${absolute}/asset/user/private/home.jsp" class="fly-case-user" target="_blank"><img src="https://tva1.sinaimg.cn/crop.0.0.118.118.180/5db11ff4gw1e77d3nqrv8j203b03cweg.jpg"></a>
...
<script src="${absolute}/asset/res/layui/layui.js"></script>
<script>
layui.cache.page = 'case';
layui.cache.user = {
  username: '游客'
  ,uid: -1
  ,avatar: '${absolute}/asset/res/images/avatar/00.jpg'
  ,experience: 83
  ,sex: '男'
};
layui.config({
  version: "3.0.0"
  ,base: '${absolute}/asset/res/mods/' //这里实际使用时，建议改成绝对路径
}).extend({
  fly: 'index'
}).use('fly');
</script>
