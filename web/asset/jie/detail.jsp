    ...
    <ul class="layui-nav fly-nav-user">
      ...
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          <dd><a href="${absolutePath}/asset/user/private/set.jsp"><i class="layui-icon">&#xe620;</i>基本设置</a></dd>
          <dd><a href="${absolutePath}/asset/user/private/message.jsp"><i class="iconfont icon-tongzhi" style="top: 4px;"></i>我的消息</a></dd>
  ...
  <div class="fly-panel fly-column">
    <div class="layui-container">
      <ul class="layui-clear">
        <li class="layui-hide-xs"><a href="${absolutePath}/index.jsp">首页</a></li>
    ...
    <div class="layui-col-md8 content detail">
      <div class="fly-panel detail-box">
        ...
        <div class="detail-about">
          <a class="fly-avatar" href="${absolutePath}/asset/user/private/home.jsp">
            <img src="https://tva1.sinaimg.cn/crop.0.0.118.118.180/5db11ff4gw1e77d3nqrv8j203b03cweg.jpg" alt="贤心">
          </a>
          <div class="fly-detail-user">
            <a href="${absolutePath}/asset/user/private/home.jsp" class="fly-link">
              <cite>贤心</cite>
...
* 更友好的响应式适配能力
          ...
          封面<hr>
          <p>
            <img src="${absolutePath}/asset/res/images/fly.jpg" alt="Fly社区">
          </p>
        </div>
      </div>
    ...
    <div class="layui-col-md4">
      ...
      <div class="fly-panel" style="padding: 20px 0; text-align: center;">
        <img src="${absolutePath}/asset/res/images/weixin.jpg" style="max-width: 100%;" alt="layui">
