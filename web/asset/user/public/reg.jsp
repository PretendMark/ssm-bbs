      ...
      <div class="layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
        <div class="layui-tab-item layui-show">
          <div class="layui-form-pane">
            <form method="post" class="layui-form"  id="uform" action="${absolutePath}/ureg/register">
              <div class="layui-form-item">
                <label for="L_email" class="layui-form-label">邮箱</label>
                <div class="layui-input-inline">
                  <input type="text" id="L_email" name="userEmail"   lay-verify="required|um"  autocomplete="off" class="layui-input"><b style="color:red"><f:errors path="userEmail"></f:errors></b>
                </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" id="L_username" name="userName"  lay-verify="required|un" autocomplete="off" class="layui-input"><b style="color:red"><f:errors path="userName"></f:errors></b>
                </div>
              </div>
              <div class="layui-form-item">
                <label for="L_pass" class="layui-form-label">密码</label>
                <div class="layui-input-inline">
                  <input type="password" id="L_pass"    lay-verify="required|pw"  autocomplete="off" class="layui-input"><b style="color:red"><f:errors path="userPassword"></f:errors></b>
                </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="password" id="L_repass"  name="userPassword"  lay-verify="required|pw|repw"  autocomplete="off" class="layui-input"><b style="color:red"><f:errors path="${errorlist.userPassword}"></f:errors></b>
                </div>
              </div>
              <div class="layui-form-item">
                <label for="L_vercode" class="layui-form-label" id="verifyCode">邮件验证码</label>
                <div class="layui-input-inline">
                  <input   type="text" id="L_vercode" name="userVerifyCode"  lay-verify="required|vc" placeholder="输入您的验证码" autocomplete="off" class="layui-input" >
...
<script src="${absolutePath}/asset/res/js/common.js" type="text/javascript"></script>
